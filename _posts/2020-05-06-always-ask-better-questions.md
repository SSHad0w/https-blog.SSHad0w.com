---
title: "Always Ask Better Questions"
date: 2020-05-06
---
...
There is no single answer that works for everyone, but there is a universal resource that gives everyone a level playing field: Google. Software developers, ethical hackers, and sysadmins all do the same thing when they don't know something, they [look it up](https://www.youtube.com/watch?v=PvLjHODBwIg). They look to see if people have had their question before, or if there is anything similar that can help them. As a beginner, you can do the same. Ask yourself what you want to do, or what job your aiming for and search for the skills associated with with the task. Start at the basics. If you want to learn how to secure your website, search web security techniques. Learn how an attacker would look for vulnerabilities within your site, and learn how a defender would patch them. Then search for the skill set needed to scan for vulnerabilities and patch them. You don't need all the answers, just a few simple questions.

[Udemy has lots of free courses](https://www.udemy.com/courses/search/?instructional_level=beginner&price=price-free&q=cybersecurity+for+beginners&sort=relevance&src=sac)
[Some College and university teachers have helpful websites](https://samsclass.info/)
[Cybrary has cheap courses as well](https://www.cybrary.it/?c=1691738072&ag=67520811113&ext=&kw=cybrary&dv=c&utm_term=cybrary&utm_campaign=BL%7CBrand%7CUsers%7CExact&utm_source=adwords&utm_medium=ppc&hsa_acc=5080772077&hsa_cam=1691738072&hsa_grp=67520811113&hsa_ad=328746354213&hsa_src=g&hsa_tgt=aud-931225835952:kwd-299510719906&hsa_kw=cybrary&hsa_mt=e&hsa_net=adwords&hsa_ver=3&gclid=CjwKCAjwwYP2BRBGEiwAkoBpAjdVmBd_7RoSz9hQTAJ2sz54xsOqTb_LM9iyykSuEYCnwTtG_zhZmRoCR_IQAvD_BwE)
[Get a degree from Youtube university](https://www.youtube.com/results?search_query=cybersecurity+basics)

####**"So I've learned the basics of what I want to know, now what?"**

You can't understand security of computer assets if you don't understand the computers themselves. Once you learn the basics of how something works, learn about how it's secured, and how those security measures can be circumvented. For example, there are lots of common security mistakes that programmers make. Just because the program works [doesn't mean it's secure](https://portswigger.net/web-security/sql-injection). This is where the questions become more specific. 
...
[Discord](https://disboard.org/servers/tag/cyber-security)
[Slack](https://www.slackchannels.com/join-cyber-security-slack-channels/)
[Twitter](https://twitter.com/hashtag/cybersecurity?lang=en)
[Youtube](https://securitytutorials.co.uk/top-10-security-youtube-channels/)
[Instagram](https://www.google.com/search?client=firefox-b-1-e&q=cybersecurity+on+instagram)
...
There's so many ways to interact with the InfoSec community, and one of the popular ways to do so is attending conventions, or ["cons"](https://www.google.com/search?q=security+conferences) for short. At these cons, people congregate to learn about different topics in security."Talks" are presentations and demonstrations on what security researchers have been learning. There's also ["Villages"](https://www.defcon.org/html/defcon-25/dc-25-villages.html) or CTFs in which people can participate in to sharpen their skills. There are lots of different cons going in the world all the time. Even if you can't travel to attend the cons, the talks are typically posted somewhere online, or the slides will be tweeted. Some Cons however, only require an internet connection. This year, I attended [VirSecCon](https://virseccon.com/) 2020 and for completely free! Cons expose people to new ideas and disciplines. Now you're given questions you didn't know you had. Finding the answer to these sometimes help you in your own research.

####**"I have some skills, and a small network in the field. How do I test my skills?"**
[Capture the flag](https://dev.to/atan/what-is-ctf-and-how-to-get-started-3f04) competitions (or CTFs) are an amazing way to test your skills. CTFs are challenges designed to test the skills of Cybersecurity practitioners or anyone willing to participate! 

CTFs are mostly offensive, but can be [defensive](https://jyvsectec.fi/services/exercises/blueteam-ctf/) focused. There are jeopardy style CTFs attack and defense CTFs, PWN challenges and [many more](https://ctffornoobs.wordpress.com/2017/05/18/different-types-of-ctfs-and-the-tools-required/)! [There are also many different styles.](https://emaragkos.gr/ctfs/ctf-categories/) There are in person CTFs at cons, but there are also many online CTFs like ones on [HackTheBox](hackthebox.eu) , [CTFtime.org](ctftime.org) , [OpenSOC.io](https://opensoc.io), and more. [Some challenges offer lots of help](https://tcode2k16.github.io/blog/posts/picoctf-2019-writeup/general-skills/), and some don't. This is what makes CTFs a great stress test to find out what you do and don't know. The best way to improve at these challenges is to look at the answers from past CTFs with similar skill sets. These are known as [writeups](https://medium.com/ctf-writeups). Some larger CTFs have prizes like lots of money, or job offers! 
