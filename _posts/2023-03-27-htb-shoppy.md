...
![cc5bdb0ba49704347c5af2d82baa69b5.png](/assets/img/htb-shoppy/b4341fbc69554f70984c8e4ea01b73f5.png)
...
![Screenshot of port 9093](/assets/img/htb-shoppy/1d527e2ce8f9412384a4d99916f296e4.png)
...
![57278404bc3e3b4ac9a6ebf29d565cce.png](/assets/img/htb-shoppy/b8e71352edf54eb9a3a218a74bab1b14.png)
...
![Similar messages from a go package](/assets/img/htb-shoppy/bb557ab01a5d423ba16f995634a201ad.png)
...
![mattermost searches](/assets/img/htb-shoppy/1890773e88c14bea895a2b74c89a7ac5.png)
...
![Mattermost Description](/assets/img/htb-shoppy/3789eb62d8d340bc9d9c08358c79c517.png)
...
![fbabb872d3e8cf0cade3acdab21bbbdd.png](/assets/img/htb-shoppy/ad9e1561a362431bb0897dbec92e2fd2.png)
...
![f77adb190252821c46e971f72ebbc548.png](/assets/img/htb-shoppy/1060cb2dddc942239d5fcc8803f45ef1.png)

It's a pretty little countdown timer. Let's check `robots.txt`.

![622c5dc741dcc3172e4fe87fb416c807.png](/assets/img/htb-shoppy/bc6563eede314d67a73ea56218691693.png)
...
![6a25af14f66a951517169f4d3a7ee139.png](/assets/img/htb-shoppy/d2fa8b2599e546ce9b9861bed079011a.png)
...
![9b2ac9763aca0e98846ba8f35e4c3223.png](/assets/img/htb-shoppy/547a07b9c6a941cb94b567cb1c8a744a.png)
...
![9eebd498d3b752b44ca7300752549d44.png](/assets/img/htb-shoppy/853a4b9333ba411794b6bd3342d101c5.png)
...
![bfc304a5718e0eeb0bc39950b14673b1.png](/assets/img/htb-shoppy/88288c3f093f4aa4a13c39f9e3a60d6f.png)

![5507c08fe5b43a27bdd7ad7d50543477.png](/assets/img/htb-shoppy/0ee8a1fcd0f34f00a92e3134d05d5b30.png)
...
![46d467b1f356274dd01d9e87d6d32106.png](/assets/img/htb-shoppy/91a745428ab649bcb552028198607348.png)

We can click the "search" button.

![05ba4f01e1cff2a4fdb4a70e108ae411.png](/assets/img/htb-shoppy/fa2d91fc3bad41a4b20dc4766499511f.png)

 Using the exploit string from before, we can see all users in the DB:

![7dc6cd0552f03256a5e8e83bcc96bfa6.png](/assets/img/htb-shoppy/3b807aeb057b4fb5a3b860181ee7e292.png)

Since our payload dumps the entire database, we receive the username and password hashes of all of the DB users:

![16e2439bbac9bed93756a5c065d3218a.png](/assets/img/htb-shoppy/62ad29d3822b43638573bb8a6398f5bd.png)
...
![914af8f2abe8d1bd9ff112b0b7d9cc70.png](/assets/img/htb-shoppy/a0354f13633a47709b99273cf8f838d2.png)
...
![a1bd93e00f48894ec74ca0dfdf4440bb.png](/assets/img/htb-shoppy/430678671c964de5a40cba99d3e4f79e.png)
...
![c8372fb670fda26c9b444eb6c151179b.png](/assets/img/htb-shoppy/6957d4322b584099922ff1401f7149fa.png)

## Mattermost.shoppy.htb

After adding that to the `/etc/hosts` file, we get this page:

![5b06723015730f7dfcfec89e0a21fecc.png](/assets/img/htb-shoppy/eabf64af92ce4366976c742cec7f26b6.png)

Let's try logging in with the credentials we learned earlier:

![c7c4a68dbfa8bfacb5386b0c7af924da.png](/assets/img/htb-shoppy/66810f79b963437480925d8e94382b2c.png)
...
![c2e9cc8c9925bbd0dfbae9a70c8c65a2.png](/assets/img/htb-shoppy/50d15cabb4064d0fad30b097fdbf62e5.png)

Don't forget to log new usernames/accounts in your notes.

![f86e329fc0673178fe388820a5d0aafe.png](/assets/img/htb-shoppy/344b66a8614d493a98df6966fc69c7b8.png)

So far, I see 4 accounts. 

We have Josh, Jess, Jager, and System.

![933de3a6bcf35f61c1b16561bd6b1c1e.png](/assets/img/htb-shoppy/d850eac62b02434dba4d72fbe8cd05c7.png)

![87fe985c305263fe71d3f8df7f841af8.png](/assets/img/htb-shoppy/4077835dfa774ac2b38434ce59a54a8b.png)
...
![0069213d85de14981e805d36bec81be3.png](/assets/img/htb-shoppy/b1ba2aae3989496cbff6c0faf77a25b8.png)

Let's check out some of their messages.

![73021e28ac9b7ea2c276ff0f4e0ccd18.png](/assets/img/htb-shoppy/4abeb264e39749deaf56894842a4b8b9.png)

Josh and Jaeger talking about the Admin interface. 

There may be a password manager written in C++.

![93affb0cb1ca863b98f66656b2de92e3.png](/assets/img/htb-shoppy/cff18dcb753c4e2bbbfcdcb2c456f6a8.png)

Jess' cat. This could be a possible password later.

![e56fa2647da268265f3d41ed32823180.png](/assets/img/htb-shoppy/8aed41fde8a64bdb8437bdabfe33e116.png)
...
![6101477327cd7b16805f266768ac5377.png](/assets/img/htb-shoppy/f97f669332764981ba6adb4312102b53.png)

![1b8c43564ed184aedef690bf0f3dc26c.png](/assets/img/htb-shoppy/f43627cbc5234e1e89992e14a5448472.png)

Neither worked.

I could try to login via SSH.

![54684d86751061e4e5f054fd166d47ca.png](/assets/img/htb-shoppy/a6abb66bdf294656bb9ece00c0f72620.png)

Sweet! I knew that password had to be used somewhere else.

![1914f9d47008aff987b0554388ab8d61.png](/assets/img/htb-shoppy/379327be8eee4f649f2b4a7e98cf2bbb.png)
...
![8ed0aecae0e321e50edc828c4cb993f7.png](/assets/img/htb-shoppy/d0747b78c0c14d6eb564046c65b1746b.png)

Running `sudo -l` gives us: 

![3bdcf9b25ba7bd576e990c1ee355ecef.png](/assets/img/htb-shoppy/55d844810fff4ce4a71dd985c7b980f4.png)

Seems like we need to inspect that file, and the ones around it.

![92966d7faf1c7ee10444d4ac80546aa8.png](/assets/img/htb-shoppy/aa7eae70ce214c02863e963f7fe22a87.png)
...
![3776b2a33dce84e3624703e1cb06cbcd.png](/assets/img/htb-shoppy/be9afd482caa4f05bfdd3280d1596251.png)

`.profile`:

![662be760b2d5770b11ff6649f389860c.png](/assets/img/htb-shoppy/6bc4d76bc64b4eaeb6796eb85a03e16e.png)
...
![4cb85abcecc8add1d6ab8754ad650d9b.png](/assets/img/htb-shoppy/82361fe6954a4dbfaf7d0e80f71299dd.png)
...
![b53b2c49a8be77ef72d09c490ceb5e35.png](/assets/img/htb-shoppy/ca4081ac832c412abd8b64dc6ce82b85.png)
...
![1d795d3cc0916aa2179e78ebe497e16f.png](/assets/img/htb-shoppy/f36cc3bd0e99431cbb567c131ff47060.png)
...
![010fa23a640d71e04a2e3a1f3ef442d4.png](/assets/img/htb-shoppy/07dbef9b0cf04a24a2f7d7c4d33aec3b.png)
...
![7728aadf87b82d6f436d9780867cdf20.png](/assets/img/htb-shoppy/5947afd56bbb4146903891e4fcc9e4ed.png)
...
![0ed258c16212f705afcd9663aca72409.png](/assets/img/htb-shoppy/d241fc5902224ff38af3211aaace327a.png)

You'll notice that we can simply scroll down and find the password harcoded in the file:

![6f4512a72fdb15e2d3c499a9f901a5a7.png](/assets/img/htb-shoppy/4d29eaa121bd4931b194cae5ae8a9046.png)
![8f3ea8cfd32243a8ca66e2f5f7deeed4.png](/assets/img/htb-shoppy/98e74de16b1e4457a175c62aa1e2ba7c.png)

Now, we see the "access granted" string like earlier!

![89c3ccf46981c0c9c7ba547e81737df5.png](/assets/img/htb-shoppy/8278069fbb744d52815182f66b567d75.png)

We can even see the execution flow of what happens after access is granted.

![1415341fa3baf2b754ed8d27501d52ca.png](/assets/img/htb-shoppy/239167781cf245f6b6a426f82db34cb1.png)

We also could have visited the function and viewed the password in the decompiler:

![440e2c25c8f92d754c180b0425867937.png](/assets/img/htb-shoppy/785724f95f3044438eb50c13230ab32c.png)

Let's go back to the copy and verify the password. 

![656b93b9bb4dc248bde0def18c3300fd.png](/assets/img/htb-shoppy/bb9f7adb3fb74bd99e0796834abcdd79.png)

It works! Let's do it for real this time on the target machine!

![a58d425aa5dfc4b529f9f2c3147f564a.png](/assets/img/htb-shoppy/28df0e920d244c59995dbdc764eda1bb.png)
...
![c3f78e1cc3f64254d7729a7c415d58bc.png](/assets/img/htb-shoppy/043833399a664878959e13d96c681127.png)

We're in. Now that we're on the other side, we can verify how the app was made.

![6e58dab930ba6aa97e7ec413a827c2a7.png](/assets/img/htb-shoppy/f93c9f5437a64fedafc32b1876b10856.png)
...
![074cd5ed18d4fd1c65cefb3f561a61ca.png](/assets/img/htb-shoppy/e069fa136dd14de5b0a7d7aca62e2208.png)
...
![59e66bdfb10633261083affb7b22b6eb.png](/assets/img/htb-shoppy/3c0446ef44d741e49fafc08d82b6b58f.png)

It seems that we don't have python on the machine. Let's try searching the machine for python and related binaries:

![d37b79ab6b87290ac604fcb2903c7b27.png](/assets/img/htb-shoppy/25262378a50d47b087e8ae890db80a35.png)
...
![c83fdd494f972c6c9de5247b2bcc8770.png](/assets/img/htb-shoppy/dbc9e1f89fbc49b8aa05804048b8051f.png)
...
![06060aee1d81d8e10e2b29c0bfae1a4e.png](/assets/img/htb-shoppy/f08dfe5c4b3049cf98ddb47b8c70403c.png)

No SUID binaries or crontab for this user. 

![cc6b2d2dc1963537bae44380013864bc.png](/assets/img/htb-shoppy/297fec373041484f8ec85c9f6ef633ca.png)
...
![ede699ec219cd085a2023e1d3cd1f091.png](/assets/img/htb-shoppy/2f14be76ac00498ea2dcb593cde7f5ff.png)
...
Client machine:
![67e3e72efdce3569e8aefa9a3e16c2dd.png](/assets/img/htb-shoppy/b4491f9057c94f27b98bd6e66f59fd07.png)

Target machine:
![25f38643b2505a212f06f7f7575786c4.png](/assets/img/htb-shoppy/a93c09b7375340eeb0c2a723489b6c29.png)
...
![4371f88ea2121066464c3efd54f84ac0.png](/assets/img/htb-shoppy/e56b35e30aff415a830ace317805cd26.png)

That output was very ugly, so I decided to go with `bash linpeas.sh -Nq > output2.txt` instead to remove color and banners.

![9b8828cec0f5fdbb8588340c19f78e09.png](/assets/img/htb-shoppy/9a244491ff8a4ba1ba7eb297c405e387.png)
...
![f1b1ec939db7e887ba70a2c638e48971.png](/assets/img/htb-shoppy/92549ded2d994f73836b6906617ee30c.png)
...
![3594679131ca9f77a7015310ae1ed681.png](/assets/img/htb-shoppy/ee8504aa59c44785b0b7c0cb4d52f95e.png)
...
![e962e2c4e88fd4685b8a861e700f7254.png](/assets/img/htb-shoppy/7a9c849b28394b929c4b020d1b87555b.png)
...
![745d3caee942702c927d4c4280fb3c40.png](/assets/img/htb-shoppy/cad618ed652d498cada18ec9d628e312.png)
